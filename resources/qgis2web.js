...
map.getView().fit([3268768.134460, -1823522.701235, 3740437.145343, -1561378.701235], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Povoados da Área de Conservação Comunitária do Distrito de Zumbo</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (122 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este é um Mapa do Web desenvolvido para mostrar o perfil dos Povoados do distrito de Zumbo, província de Tete, Moçambique ';
            }
